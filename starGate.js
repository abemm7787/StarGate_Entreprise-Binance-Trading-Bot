...
function display_array() {
    ...
    for (var y = 0; y < stopLoss.length; y++) {
        ...
        e += "Stop Lost In Placed  " +   stopLoss[y] + " ..." + "Smart Index " + y +  "<br/>"
...
// // When remove the two from candleseriesTwo and from setdata. The chart reapears and dispears the main chart must figure out why.
//      var candleSeriesTwo = chart.addCandlestickSeries(); // deploys chart

//  var startTwo = new Date(Date.now() - (7200 * 1000)).toISOString()

//  var bars_url = 'https://data.alpaca.markets/v1beta1/crypto/ETHUSD/bars?exchanges=CBSE&timeframe=1Min&start=' + startTwo;
// _

//     var dataTwo = response.bars.map(bar => (
//         {
//             open: bar.o,
//             high: bar.h,
//             low: bar.l,
...
//     currentBar = dataTwo[dataTwo.length - 1]
//     candleSeriesTwo.setData(dataTwo)

// 	series.setData(dataTwo);

// 	var minimumPrice = dataTwo[0].value;
// 	var maximumPrice = minimumPrice;
// 	for(var i = 1; i < dataTwo.length; i++) {
// 		var price = dataTwo[i].value;
// 		if (price > maximumPrice) {
// 			maximumPrice = price;
// 		}
// 		if (price < minimumPrice) {
